...
if ( !class_exists( 'WPSL_Frontend' ) ) {
    ...
    class WPSL_Frontend {
        ...
        public function show_store_address( $atts ) {
            ...
            $content = '<div class="col-md-8 col-6 p-0 wpsl-locations-details">';
        ...
        public function show_store_map( $atts ) {
            ...
            $output = '<div class="row container-fluid m-0 p-0"><div id="wpsl-base-gmap_' . self::$map_count . '" class="col-12 wpsl-gmap-canvas float-right"></div>' . "\r\n";
