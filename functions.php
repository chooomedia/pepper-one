...
function wp_bootstrap_starter_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer CTA', 'wp-bootstrap-starter' ),
        'id'            => 'footer-cta',
        'description'   => esc_html__( 'Add HTML Code here to insert some CTA Buttons in the footer area', 'wp-bootstrap-starter' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '',
        'after_title'   => '',
...
function wp_bootstrap_starter_scripts() {
    ...
    if(get_theme_mod( 'preset_style_setting' ) === 'baskervville-cuciniale') {
        wp_enqueue_style( 'wp-bootstrap-starter-baskervville-cuciniale', 'https://fonts.googleapis.com/css?family=Baskervville&display=swap' );
    }
